...
function getCenter(node: TaskNode) {
  return {
...
function getRectangleBorderPoint(radians: number, size: { width: number; height: number }, sideOffset = 0) {
...
export function getPoints(r1: TaskNode, r2: TaskNode) {
  if(!r1 || !r2) {
    console.log(r1, r2)
    return
  }
